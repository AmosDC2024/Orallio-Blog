        ...
        <div className="max-w-4xl mx-auto p-10 sm:p-14 rounded-2xl bg-white border border-slate-200/90 shadow-sm text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
              Whether you are looking to source quality agricultural commodities, accelerate corporate digital strategy, or manage global travel mobility—Orallio Group is ready to partner with you.
            </p>
          </div>
